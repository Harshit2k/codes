...
Original file is located at
    https://colab.research.google.com/drive/1VN_ZANUt8GS5quiOOqkAU1vTjH25lvQZ
...
sns.violinplot(x = 'Embarked', y = 'Pclass', data = train_df, hue = 'Sex')

#Relation_between_sex_and_survival_rate
train_df[['Survived','Sex']].groupby(['Sex'],as_index=False).mean()

plt.figure(figsize = (15,6))
sns.pointplot(data = train_df, x = 'Pclass', y = 'Survived', hue = 'Sex')

"""Women has a higher rate of survival."""

#Realtionship_between_class_and_survival_rate
train_df[['Survived','Sex','Pclass']].groupby(['Pclass', 'Sex']).mean()
...
"""Sites from which i took refernce:

-> towardsdatscience.com
